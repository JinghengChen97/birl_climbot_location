...
Eigen::Matrix4d Kine_CR_FiveDoF_G1::FKineMatrixEigen(double gdJPos[], double gdCPos[]) {
    // 关节角度 - 关节弧度 - Tcp矩阵 - 位姿
    ...
    Eigen::Matrix4d ret;
    ret<<lm_Tcp.R11, lm_Tcp.R12, lm_Tcp.R13, gdCPos[0],
            lm_Tcp.R21, lm_Tcp.R22, lm_Tcp.R23, gdCPos[1],
            lm_Tcp.R31, lm_Tcp.R32, lm_Tcp.R33, gdCPos[2],
            0, 0, 0, 1;
